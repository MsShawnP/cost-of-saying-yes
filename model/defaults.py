...
RETAILER_DEFAULTS = {
    "walmart": {
        ...
        "chargeback_rate_learning": 0.12,   # months 1-3 — back-solved from Cinderhaven: $14,976 / (3 × $41,568) = 12%
...
# These are the authoritative case study figures; do NOT recompute them from the model.
